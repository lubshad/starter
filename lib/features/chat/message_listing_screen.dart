...
class _MessageListingScreenState extends State<MessageListingScreen> {
  PagingController<String?, ChatMessage> pagingController =
      PagingController(firstPageKey: null);
  @override
  void initState() {
    pagingController
        .addPageRequestListener((pageKey) => fetchMessages(pageKey));
    addMessageListener();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.conversation.id.toString()),
      ),
      body: Column(
        children: [
          Expanded(
            ...
            Expanded(
              child: SizedBox(
                ...
                child: TextField(
                  ...
                  onChanged: (value) => AgoraUtils.i
                      .sendTypingIndicator(id: widget.conversation.id),
                ),
              ),
            ),
            gap,
